...
const ProjectCard = ({ props }) => {
  ...
  return (
    <Link href={link} target="_blank">
      <div className="h-[100px] w-[200px] md:h-[200px] md:w-[400px] lg:h-[300px] lg:w-[600px] border border-zinc-600 flex flex-col justify-center items-center gap-2 rounded-xl hover:border-zinc-800 ease-in-out duration-1000 ">
