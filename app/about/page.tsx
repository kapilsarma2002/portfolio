...
const About = () => {
  return (
    <div className="h-screen w-screen">
      <Navbar />
      <div className="h-[calc(100vh-4rem)] w-screen flex flex-row justify-between gap-1 items-center">
        <div className="h-full w-11/12 flex justify-center items-center">
          <Image src="/code1.jpg" height="1000" width="1200" alt="coding image" />
        </div>
        <div className="h-full w-full ">
          <div className="h-full w-full text-slate text-2xl text-zinc-400">
            <ul className="h-full w-full flex flex-col gap-3 items-left pr-[200px] justify-center">
              ...
              <li>
                ...
                <div className="text-2xl text-zinc-500 my-2">
                  React, Next, Angular, Node, C++ (for problem solving), Python,
                  SQL, Java
                </div>
              </li>
            </ul>
